...
export default function BlogPost() {
  ...
  const loadBlog = async () => {
    try {
      ...
      // 🔥 Using your new API service
      const blogPost = await BlogService.getBlogDetailPublic(slug);
      ...
      <section className="relative bg-black text-white py-20">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
          >
            {/* ✅ Category Name (Nested object from backend) */}
            <span className="px-4 py-2 bg-yellow-400 text-black text-sm font-bold rounded-full inline-block mb-6">
            ...
            <div className="flex items-center gap-6 text-gray-300">
              ...
              <div className="flex items-center gap-2">
                <Calendar className="w-5 h-5" />
                <span>
                  {new Date(blog.created_at || blog.published_date).toLocaleDateString('en-US', {
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
                  })}
        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-black/80 mb-6">
              Join FitHive today and start your fitness journey
            </p>
            <Link to={createPageUrl('Packages')}>
              <Button className="bg-black text-white hover:bg-gray-800 font-bold px-8 py-6 text-lg">
                View Our Packages →
